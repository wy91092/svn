...
#include<iostream>
using namespace std;
WorkShop::WorkShop(std::size_t num_producer,std::size_t num_consumer):_queue(),_num_producer(num_producer),_num_consumer(num_consumer),_producers(_num_producer,Producer(& _queue)),_consumers(_num_consumer, Consumer(& _queue))
{}
WorkShop::~WorkShop(){}
void WorkShop::start()
{ 
